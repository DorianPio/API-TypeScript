/**
 * This type contains all the HTTP statusCode and all the associated {description
 */
...
export type StatusType = typeof status_ & {
  [x: number]: { description: string };
};

export const status: StatusType = status_;
